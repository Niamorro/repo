            ...
            for contour in contours:
                ...
                if area > 100:
                    ...
                    if M["m00"] != 0:
                        ...
                        is_new_car = min_distance > 1.0
                        
                        # Always draw the contour and center regardless of whether it's a new car
                        cv2.drawContours(debug_image, [contour], -1, (0, 255, 0), 2)
                        cv2.circle(debug_image, (cx, cy), 5, (0, 0, 255), -1)
                        
                        # Only process new cars for velocity calculation and detection
                        if is_new_car:
